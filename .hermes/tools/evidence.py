"""Backward-compatibility shim: re-exports `asha.evidence` in place of the
...
_real = _importlib.import_module("asha.evidence")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.evidence", run_name="__main__", alter_sys=True)
