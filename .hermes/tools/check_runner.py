"""Backward-compatibility shim: re-exports `asha.check_runner` in place of the
...
from asha.check_runner import *

_real = _importlib.import_module("asha.check_runner")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.check_runner", run_name="__main__", alter_sys=True)
