"""Backward-compatibility shim: re-exports `asha.runner` in place of the
...
from asha.runner import *

_real = _importlib.import_module("asha.runner")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.runner", run_name="__main__", alter_sys=True)
