"""Backward-compatibility shim: re-exports `asha.conflict` in place of the
...
from asha.conflict import *

_real = _importlib.import_module("asha.conflict")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.conflict", run_name="__main__", alter_sys=True)
