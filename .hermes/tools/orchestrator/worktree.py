"""Backward-compatibility shim: re-exports `asha.worktree` in place of the
...
_real = _importlib.import_module("asha.worktree")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.worktree", run_name="__main__", alter_sys=True)
from asha.worktree import _commit_all, _git, _safe_id  # noqa: F401
