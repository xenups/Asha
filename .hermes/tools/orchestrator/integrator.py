"""Backward-compatibility shim: re-exports `asha.integrator` in place of the
...
from asha.integrator import *

_real = _importlib.import_module("asha.integrator")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.integrator", run_name="__main__", alter_sys=True)
