"""Backward-compatibility shim: re-exports `asha.scheduler` in place of the
...
from asha.scheduler import *

_real = _importlib.import_module("asha.scheduler")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.scheduler", run_name="__main__", alter_sys=True)
