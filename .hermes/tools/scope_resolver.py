"""Backward-compatibility shim: re-exports `asha.scope_resolver` in place of the
...
from asha.scope_resolver import *

_real = _importlib.import_module("asha.scope_resolver")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.scope_resolver", run_name="__main__", alter_sys=True)
