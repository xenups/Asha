"""Backward-compatibility shim: re-exports `asha.graph_state` in place of the
...
from asha.graph_state import *

_real = _importlib.import_module("asha.graph_state")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.graph_state", run_name="__main__", alter_sys=True)
