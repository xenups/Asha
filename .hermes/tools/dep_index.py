"""Backward-compatibility shim: re-exports `asha.dep_index` in place of the
...
from asha.dep_index import *

_real = _importlib.import_module("asha.dep_index")
...
if __name__ == "__main__":
    ...
    _runpy.run_module("asha.dep_index", run_name="__main__", alter_sys=True)
